                ...
                <div className="flex flex-col items-center justify-between xl:flex-row">
                    <div className="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
                        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                            Fill this form to get <br className="hidden md:block" />
                            subscribed for{' '}
                    ...
                    <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
                        <div className="relative">
                            ...
                            <div className="relative bg-white rounded shadow-2xl p-7 sm:p-10">
                                <h3 className="mb-4 text-xl font-semibold sm:text-center sm:mb-6 sm:text-2xl text-blue-400">
                                    Sign up for updates
                                </h3>
                                <form onSubmit={subscribeMe}>
                                    <div className="mb-1 sm:mb-2 text-gray-900">
                                        <label
                                            htmlFor="email"
                                    ...
                                    <p className="text-xs text-gray-600 sm:text-sm">
                                        {subscriberCount} has subscribed
                                    </p>
                                </form>
                                <div>
                                    {success
