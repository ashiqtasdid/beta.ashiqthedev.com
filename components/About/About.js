                ...
                <div className="mb-16 lg:max-w-lg lg:mb-0">
                    <div className="max-w-xl mb-6">
                        ...
                        <p className="text-base text-gray-700 md:text-lg">
                            Ashiq The Dev was founded by Md. Ashiquzzaman khan tasdid in Dec, 2020. At first, it was a web development company. But, as time passed it grew, now It is an IT consultant company, it provides various kind of IT services like, SEO, Web Development, Software Development, Server Deployment, etc.
                        </p>
                    </div>
